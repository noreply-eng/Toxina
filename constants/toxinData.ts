...
export const dosisData: ToxinData = {
  Dysport: {
    ...
    "Buccinator": { min: 12, max: 38 },
    "Cervical Paraspinals": { min: 50, max: 100 },
    "Corrugator": { min: 25, max: 50 },
    "Depressor anguli oris": { min: 10, max: 25 },
    "Depressor labii inferioris": { min: 5, max: 15 },
    "Depressor supercilii": { min: 10, max: 20 },
    "Frontalis": { min: 50, max: 100 },
    "Levator anguli oris": { min: 5, max: 10 },
    "Levator labii superioris": { min: 5, max: 15 },
    "Levator labii superioris alaeque nasi": { min: 5, max: 10 },
    "Masseter": { min: 50, max: 125 },
    "Mentalis": { min: 10, max: 20 },
    "Nasalis": { min: 5, max: 15 },
    "Occipitalis": { min: 75, max: 150 },
    "Orbicularis oculi": { min: 30, max: 72 },
    "Orbicularis oris": { min: 10, max: 25 },
    "Platysma": { min: 25, max: 75 },
    "Procerus": { min: 12, max: 25 },
    "Risorius": { min: 3, max: 10 },
    "Temporalis": { min: 100, max: 200 },
    "Trapezius": { min: 75, max: 150 },
    "Zygomaticus major": { min: 5, max: 15 },
    "Zygomaticus minor": { min: 3, max: 10 },
    
    // Spasticity Muscles
    "Abductor hallucis": { min: 40, max: 80 },
    "Abductor pollicis longus": { min: 50, max: 90 },
    "Adductor longus": { min: 125, max: 250 },
    "Adductor magnus": { min: 250, max: 500 },
    "Adductor pollicis": { min: 12, max: 50 },
    ...
    "Elevador de la escápula": { min: 50, max: 125 },
    "Esplenio de la cabeza": { min: 75, max: 200 },
    "Esternocleidomastoideo": { min: 50, max: 125 },
    ...
    "Lateral pterygoid": { min: 12, max: 38 },
    "Medial pterygoid": { min: 25, max: 75 },
  ...
  Botox: {
    // Facial and Migraine Muscles (standardized nomenclature)
    "Buccinator": { min: 5, max: 15 },
    "Cervical Paraspinals": { min: 20, max: 40 },
    "Corrugator": { min: 10, max: 20 },
    "Depressor anguli oris": { min: 4, max: 10 },
    "Depressor labii inferioris": { min: 2, max: 6 },
    "Depressor supercilii": { min: 4, max: 8 },
    "Frontalis": { min: 20, max: 40 },
    "Levator anguli oris": { min: 2, max: 4 },
    "Levator labii superioris": { min: 2, max: 6 },
    "Levator labii superioris alaeque nasi": { min: 2, max: 4 },
    "Masseter": { min: 20, max: 50 },
    "Mentalis": { min: 4, max: 8 },
    "Nasalis": { min: 2, max: 6 },
    "Occipitalis": { min: 30, max: 60 },
    "Orbicularis oculi": { min: 12, max: 24 },
    "Orbicularis oris": { min: 4, max: 10 },
    "Platysma": { min: 10, max: 30 },
    "Procerus": { min: 5, max: 10 },
    "Risorius": { min: 1, max: 4 },
    "Temporalis": { min: 40, max: 80 },
    "Trapezius": { min: 30, max: 60 },
    "Zygomaticus major": { min: 2, max: 6 },
    "Zygomaticus minor": { min: 1, max: 4 },
    
    // Spasticity Muscles
    "Abductor hallucis": { min: 10, max: 20 },
    "Abductor pollicis longus": { min: 20, max: 30 },
    "Adductor longus": { min: 50, max: 100 },
    "Adductor magnus": { min: 100, max: 200 },
    "Adductor pollicis": { min: 5, max: 20 },
    ...
    "Elevador de la escápula": { min: 20, max: 50 },
    "Esplenio de la cabeza": { min: 30, max: 80 },
    "Esternocleidomastoideo": { min: 20, max: 50 },
    ...
    "Lateral pterygoid": { min: 5, max: 15 },
    "Medial pterygoid": { min: 10, max: 30 },
...
export const puntosMotoresData: Record<string, string> = {
  ...
  "Abductor pollicis longus": "Con el antebrazo en pronación, palpa el compartimento móvil del pulgar en el tercio medio-distal del antebrazo dorsal-radial, proximal a la tabaquera anatómica. Solicita abducción del pulgar en el plano del dorso de la mano; el punto motor se halla donde la contracción sea máxima con mínima estimulación, evitando confusión con EPB/EPL.",
  ...
  "Adductor pollicis": "Localiza la eminencia tenar profunda entre la base del primer metacarpiano y la cabeza del segundo. Con el pulgar en ligera oposición al índice, el punto motor corresponde a la aducción del pulgar con mínima estimulación, aproximadamente en el centro del espacio intermetacarpiano I–II profundizando bajo el primer interóseo dorsal.",
  "Adductor pollicis longus": "Nota: clave histórica; preferir 'Adductor pollicis' (mano) o 'Abductor pollicis longus' (antebrazo). Para aductor del pulgar: eminencia tenar / espacio I–II metacarpiano; para abductor largo: compartimento móvil del pulgar en antebrazo dorsal-radial.",
  "Elevador de la escápula": "Paciente sentado. Palpa el borde posterolateral del cuello, entre la apófisis transversa de C1–C4 y el ángulo superior de la escápula. El vientre se siente bajo el trapecio superior. Solicita elevación de la escápula con rotación inferior; el punto motor suele situarse a 2–3 cm medial al ángulo superior escapular, con USG/EMG recomendados por proximidad a plexo y vasos.",
  "Esplenio de la cabeza": "Paciente sentado o en prono. Palpa en el cuello posterolateral, bajo el trapecio superior, a nivel C2–C4 y ~2–4 cm lateral a la línea media. Solicita extensión y rotación ipsilateral de la cabeza; el punto motor se confirma donde la contracción sea máxima con mínima corriente. Evitar inyección demasiado profunda hacia estructuras vasculares.",
  "Esternocleidomastoideo": "Paciente sentado con la cabeza en rotación contralateral ligera. Palpa el vientre clavicular y esternal del ECM. Los puntos motores habituales están en el tercio medio del vientre muscular. Limitar dosis y evitar inyección bilateral alta por riesgo de disfagia; confirmar con rotación ipsilateral / flexión lateral.",
  ...
  "Lateral pterygoid": "Abordaje intraoral o extraoral guiado (USG/EMG). El músculo se sitúa en la fosa infratemporal, profundo al arco cigomático. Extraoral: ~1–1.5 cm por delante del trago y ~1 cm bajo el arco cigomático, profundidad controlada. Confirmar con protrusión mandibular. Dosis bajas; riesgo de hemorragia o compromiso de la ATM.",
  "Medial pterygoid": "Abordaje intraoral preferente (cara medial de la rama mandibular) o extraoral guiado. El vientre se palpa en el ángulo mandibular interno. Solicita elevación/protrusión mandibular; 1–2 puntos. USG o EMG recomendados por proximidad a vasos y glándula parótida.",
